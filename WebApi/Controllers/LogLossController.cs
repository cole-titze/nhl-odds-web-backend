...
namespace WebApi.Controllers
{
    ...
    public class LogLossController
	{
        ...
        public LogLossController(ILogger<PredictedGameController> logger, ILogLossCalculator logLossBL)
        {
            _logger = logger;
        ...
        /// Example Call: http://localhost:32616/api/logloss/GetLogLossesOfYearByNumberOfGames?year=2021&numberofgames=10
        /// </summary>
